      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] z-50 top-[34px] sm:top-[3px] md:right-[5px] md:top-[5px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
...
export async function action({ request }) {
  ...
  if (!isValidPhone(data.phone))
    errors.phone =
      "please give us your currect phone numbers we might need is to contact you.";
